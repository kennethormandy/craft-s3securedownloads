...
class S3SecureDownloadsPlugin extends BasePlugin
{
    /**
    ...
    {
         return Craft::t('S3 Secure Downloads');
    }
    ...
    {
        return Craft::t('Return an AWS signed URL and proxy the download request.');
    }
    ...
    {
        return 'http://jonathanmelville.com';
    }
    ...
    {
        Craft::import('plugins.s3securedownloads.twigextensions.S3SecureDownloadsTwigExtension');

        return new S3SecureDownloadsTwigExtension();
    }
    ...
    {
       return craft()->templates->render('s3securedownloads/S3SecureDownloads_Settings', array(
